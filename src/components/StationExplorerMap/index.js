        ...
        return (
            <div className="StationExplorerMap">
                    <Map
                        ...
                        style={{
                            height:(this.state.width>960) ? '300px' : '400px',
                            width:(this.state.width>960) ? this.state.width*0.43 : this.state.width*0.86,
                        }}
                    >
                        <TileLayer
                        ...
                        <GeoJSON
                            ...
                            onEachFeature={app.nationOnEachFeature_explorer}
                        />
